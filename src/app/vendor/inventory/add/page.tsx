// src/app/vendor/inventory/add/page.tsx
"use client";
...
import { addItemToInventory } from "@/firebase/inventory";
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			if (costValue > priceValue) {
				setError("Cost price should not exceed selling price");
				setIsSubmitting(false);
				return;
			}
			...
			// Image URL to be set after possible upload
			let finalImageUrl = imageUrl || "/placeholder-image.png";
			...
			const newItem = {
				...
				units: unitsValue,
				image: finalImageUrl,
				tags: tags.length > 0 ? tags : ["other"], // Default tag if none provided
			...
			const result = await addItemToInventory(newItem);
					...
					<div className="p-6">
						...
						<form onSubmit={handleSubmit} className="text-gray-700">
							...
							<div className="mb-6">
								...
								<div className="flex">
									...
									<button
										type="button"
										onClick={addTag}
										className="bg-puce hover:bg-rose text-white py-2 px-4 rounded-r-md"
									>
										Add
									</button>
								</div>
							...
							<div className="flex justify-end space-x-4">
								...
								<button
									type="submit"
									className="px-4 py-2 bg-puce hover:bg-rose text-white rounded-md shadow-sm"
